...
![Nonlinear graticules, missing data](images/map6.0.png)
...
-  **Strong local data sources** Campus recently renovated a golf course into an open space.
-  **Existing materials** We built on an existing Carpentries lesson.

![??](images/map7_row_1.png)
